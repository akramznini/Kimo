              ...
              children: [
                ...
                Expanded(
                  child: ListView(
                    children: [
                      SizedBox(height: 20,),
                      HostPreviewContainer(listingOwner: listingOwner),
                      Padding(
                ...
                (tripIsReviewed || widget.trip.isCancelled || DateTime.fromMillisecondsSinceEpoch(widget.trip.endDate.millisecondsSinceEpoch).add(Duration(days: 7)).millisecondsSinceEpoch < DateTime.now().millisecondsSinceEpoch) ? SizedBox() : Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: Column(
