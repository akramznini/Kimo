                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              SizedBox(width: 10,),
                              GestureDetector(child: Text("Sign Up", style: robotoRegularBoldPrimary,), onTap: () => Navigator.of(context).push(MaterialPageRoute(builder: (context) => SignUpPage())),)
                            ],
                          ), 
                          SizedBox(height: 20,),
      ...
      return null;
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(content: Text("Your email or password is incorrect.")),
                  ...
                  SizedBox(height: 20,),
                  GestureDetector(child: Text("Forgot Password", style: robotoRegularBoldPrimary,), onTap: (){Navigator.of(context).push(MaterialPageRoute(builder: (context) => PasswordResetPage()));},),
